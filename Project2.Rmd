...
knitr::opts_knit$set(root.dir = normalizePath("Document"))
```
...
# Draw a legend.
plot(legend(0.6, 0.6, c('rpart', 'ctree', 'cforest','bagging','svm'), 2:6))
plot.new()
# ctree
...
classifier1 <- x.rp.prob[,2] 
classifier2 <- x.ct.prob
classifier3 <- x.cf.prob
classifier4 <- x.ip.prob[,2]
classifier5 <- as.numeric(x.svm.prob)
combine.df <- data.frame(classifier1, classifier2, classifier3, classifier4, classifier5 )
combine.df
str(combine.df)
